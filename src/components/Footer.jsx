...
// const Footer = () => {
//   return (
//     <footer className="footer footer-center mt-[85px] h-[190px] pt-3 justify-evenly bg-gray-700 text-base-content rounded ">
//       <div className="container mx-auto flex flex-col ">
//         {/* Navigation links */}
//         <nav className="grid grid-flow-col  mb-4 text-center text-xl hover:cursor-pointer">
...
//                 height="24"
//                 viewBox="0 0 24 24"
//                 className="fill-current hover:text-red-400" 
//               >
    ...
    <footer className="bg-gray-800 text-white py-10 mt-10">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
        ...
        <aside className="text-center md:text-right">
          ...
          <p className="text-sm">Powered by ACME Industries Ltd.</p>
        </aside>
      </div>
    </footer>
  );
